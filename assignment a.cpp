...
int mainMenu(){
char c;
cout<<"enter char to enter"<<endl;
cout<<"press 1 to enter artist manager"<<endl;
cout<<"press 2 to enter album manager"<<endl;
cout<<"press 3 to enter previous menu"<<endl;
cout<<"enter char to enter"<<endl
cin>>c;
switch (c){
        case '1':
...
char c;
cout<<"enter char to enter"<<endl;
cout<<"press 1 to display all artists"<<endl;
cout<<"press 2 to display artist by search"<<endl;
cout<<"press 3 to enter previous menu"<<endl;
cout<<"enter char to enter"<<endl
cin>>c;
switch (c){
